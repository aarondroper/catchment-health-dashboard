...
- **Status:** Accepted implementation decision for the local MVP on 2026-09-13; public delivery remains gated
...
- **Consequences:** The local map is geographically meaningful but intentionally not a full basemap. Runtime detail is staged without weakening normalized/audit assets or export provenance. The runtime shell/partitions, raw responses, and generated observations remain ignored; public observation delivery, freshness, attribution implementation, and any basemap reuse terms remain release gates.
