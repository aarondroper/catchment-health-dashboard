...
- **Status:** Release-readiness review completed on 2026-09-13; owner decision required only for a future public distribution route
...
- **Consequences:** The application includes official attribution and source links, retains retrieval/build metadata, and has a local-safe `tools/check_release_readiness.py` gate. Public deployment and downloadable observation export remain blocked; no generated or raw observation data is committed.
