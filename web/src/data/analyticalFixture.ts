...
export const analyticalFixture: AnalyticalAsset = {
  ...
  analyticalVersion: "ashburton-analytical-v2-quality-semantics",
  ...
  stationCatalog: [{ stationId: "station-ash-001", name: "Ashburton River test station" }],
  observations: [
    {
      observationId: "obs-001", stationId: "station-ash-001", parameterId: "nitrate_n_nitrite_n", observedAt: "2024-01-15T10:00:00+12:00",
      value: 0.42, resultText: "0.42", originalUnit: "g/m3", qualityFlag: null, qualityRepresentation: "missing_field",
      qualityDisposition: "missing_quality_field", censoring: null, valueKind: "observed_numeric", analysisEligible: false,
    },
    {
      observationId: "obs-002", stationId: "station-ash-001", parameterId: "nitrate_n_nitrite_n", observedAt: "2024-02-15T10:00:00+12:00",
      value: null, resultText: "<0.01", originalUnit: "g/m3", qualityFlag: "600", qualityRepresentation: "nonempty_code",
